...
- ⚽ **[Football Event Data & Stochastic Match Modeling (Python)](https://github.com/deste37/football-event-data-analytics):** Suite modulare di match analysis avanzata su open data ufficiali StatsBomb:
  ...
  - 🎰 **[Monte Carlo Euro 2024 Web App (Streamlit)](https://montecarlosimulationeuro2024.streamlit.app/):** Web Application interattiva a tema *Monte Carlo Casino* per la simulazione 1X2 in tempo reale e Sandbox *"What If..."* per la modifica dinamica delle occasioni da gol.
...
## ⚽ Match Analysis & Football Analytics
